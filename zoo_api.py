...
class zoo_video_upload(object):
    def __init__(self,username, password, project_name, subject_set_number, videos_file_path):
        ...
        self.compressed_video_dir = self.make_dir(self.videos_file_path)
    ...
    def main(self):
        ...
        for video in videos:
            ...
            self.make_new_single_subject(project = self.project,
                                    ...
                                    video_file_path = compressed_vid_file_name,
                                    metadata=metadata)
